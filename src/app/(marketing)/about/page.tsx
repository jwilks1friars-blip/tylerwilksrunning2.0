        ...
        <div className="grid md:grid-cols-2 gap-16">
          <div>
            ...
            <div className="space-y-5 text-sm leading-8" style={{ color: '#6b6560' }}>
              <p>
                I started running in college — badly. Too fast on easy days, not hard enough on hard days, no structure, no recovery. I got injured constantly and couldn't figure out why.
              </p>
              <p>
